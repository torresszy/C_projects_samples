...
RUBRIC = [
          ("Task 1: Create new image", "new_ppm", 7),
          ("Task 1: Free image", "free_ppm", 7),
          ("Task 2: Create negative image", "create_negative", 14),
          ("Task 3: Create greyscale image", "create_greyscale", 14),
          ("Task 4: Blur image", "blur", 28)
         ]
