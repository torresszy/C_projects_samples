...
RUBRIC = [
          ("Create a trie node", "create_trie_node", 5),
          ("Add a word to a trie", "add_word", 20),
          ("Determine if a word is in a trie", "is_a_word", 7),
          ("Get the number of completions", "num_completions", 8),
          ("Get the completions", "get_completions", 20)
         ]
