...
RUBRIC = [
          ("Create a graph", "graph_create", 5),
          ("Create a node in a graph", "node_create", 5),
          ("Add an edge between nodes", "add_edge", 15),
          ("A* search cost", "a_star", 30),
          ("A* search parent", "a_star_parent", 5)
