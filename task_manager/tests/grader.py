...
RUBRIC = [
          ("Task 1: Add a task", "tm_add_task", 10),
          ("Task 1: Is empty", "tm_is_empty", 5),
          ("Task 1: Get the number of tasks", "tm_get_num_tasks", 9),
          ("Task 1: Get the maximum priority", "tm_get_max_priority", 1),
          ("Task 1: Get the number of jobs by priority", "tm_get_num_jobs_by_priority", 10),
          ("Task 1: Remove a task", "tm_remove_task", 10),
          ("Task 1: Run a cycle", "tm_run_cycle", 10),
          ("Task 2: Run the tasks", "run_tasks", 5),    
         ]
