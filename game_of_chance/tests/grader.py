...
RUBRIC = [
          ("Task 1: One Dollar", "one_dollar", 10),
          ("Task 1: Double On Win", "double_on_win", 15),
          ("Task 1: Double On Loss", "double_on_loss", 15),
          ("Task 1: Fibonacci Strategy", "fib_strategy", 20),
          ("Task 1: Series Strategy", "series_strategy", 25),
          ("Task 2: Multiple games - One Dollar", "multiple_one_dollar", 3),
          ("Task 2: Multiple games - Double on Win", "multiple_double_on_win", 3),
          ("Task 2: Multiple games - Double on Loss", "multiple_double_on_loss", 3),
          ("Task 2: Multiple games - Fibonacci Strategy", "multiple_fib_strategy", 3),
          ("Task 2: Multiple games - Series Strategy", "multiple_series_strategy", 3)
         ]
